...
public class LotteryTest {
    ...
    public void mockedLottery() {
        ...
        when(emailsReader.get()).thenReturn(List.of("0", "1", "2", "3", "4"));
    ...
    public void mockedWithSpy() {
        ...
        assertEquals(LotteryMachine.DEFAULT_SEED, lotteryMachine.getSeed());
        assertEquals(longSeed, spyMachine.getSeed()); //not to seedString.hashCode();
    }
}
